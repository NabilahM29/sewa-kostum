...
<section class="hero is-success">
    <div class="hero-body">
        <div class="container">
            ...
            <h2 class="subtitle">Kostum Cosplayer yang dipilih: {{ $data->kategori ? $data->kategori->nama_barang : '' }}</h2>
        </div>
    </div>
</section>
                        ...
                        <div class="content">
                            <table class="table is-fullwidth is-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Bukti Jaminan (foto KTP anda)</th>
                                        <td>
                                            @if($data->gambar)
                                                <div class="image-container">
                                                    <img src="{{ asset('storage/' . $data->gambar) }}" alt="Jaminan Bukti (foto KTP anda)">
                                                </div>
                                            @else
